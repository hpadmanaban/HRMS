    ...
    public static List<LeaveApplication> readAllApplicationsForAnEmployee(String employeeCode) throws SQLException
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                leaveApplication.setApplicationDate(new java.util.Date(rs.getDate("application_date").getTime()));
                ...
                leaveApplication.setEndDate(new java.util.Date(rs.getDate("leave_end_date").getTime()));
                ...
                leaveApplication.setStartDate(new java.util.Date(rs.getDate("leave_start_date").getTime()));
