...
public class Employee {
    ...
    public void read() throws SQLException
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                dateOfBirth = new Date(rs.getDate("DATE_OF_BIRTH").getTime());
                dateOfJoining = new Date(rs.getDate("DATE_OF_JOINING").getTime());
                probationaryPeriod = rs.getInt("probationary_period");
                if(rs.getDate("date_of_confirmation") != null)
                {
                    dateOfConfirmation = new Date(rs.getDate("date_of_confirmation").getTime());
                }
    ...
    public static List<Employee> readAllActiveEmployeesWhereEmployeeCodeIsNot(String employeeCode) throws SQLException
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                employeeMaster.setDateOfBirth(new Date(rs.getDate("DATE_OF_BIRTH").getTime()));
                employeeMaster.setDateOfJoining(new Date(rs.getDate("DATE_OF_JOINING").getTime()));
                employeeMaster.setProbationaryPeriod(rs.getInt("probationary_period"));
                if(rs.getDate("date_of_confirmation") != null)
                {
                    employeeMaster.setDateOfConfirmation(new Date(rs.getDate("date_of_confirmation").getTime()));
                }
    ...
    public static List<Employee> readAllRegularEmplyeesNotSeparatedInMonth(int month,int year) throws SQLException
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                {
                    employeeMaster.setDateOfSeparation(new Date(rs.getDate("DATE_OF_SEPARATION").getTime()));
                }
                employeeMaster.setProbationaryPeriod(rs.getInt("probationary_period"));
                if(rs.getDate("date_of_confirmation") != null)
                {
    ...
    public static List readAllSeparatedEmployees(Date fromDate,Date toDate) throws SQLException
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                employee.setDateOfSeparation(new Date(rs.getDate("DATE_OF_SEPARATION").getTime()));
                employeesList.add(employee);
            }
            ps.close();
            rs.close();
    ...
    public String checkValidUser() throws SQLException
    {
        ...
        while(rs.next())
        {
            ...
            dobInDb = new Date(rs.getDate("date_of_birth").getTime());
            if(rs.getString("can_raise_recruitment_requirement_request") == null)
            {
                canRaiseRecruitmentRequirementRequest ="N";
            }
